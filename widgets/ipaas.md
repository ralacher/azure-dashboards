Sample application to demonstrate a public nuisance reporting use case. A Power App submits complaints from citizens, uses image recognition to triage, and stores the complaints in a database.
